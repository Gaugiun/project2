...
import com.stylefeng.guns.rest.common.utils.COSFileUploadUtil;
...
public class AlipayServiceImpl implements AlipayService {
    ...
    public String trade_precreate(String orderId) {
        ...
        // 获取订单信息
        OrderVOR orderVOR = orderService.getOrderInfoById(orderId);
        ...
        String totalAmount = orderVOR.getOrderPrice();
        ...
        String body = "购买电影票共花费"+ orderVOR.getOrderPrice();
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                filePath = String.format("C:/Users/王唯聪/Desktop/qrcode/qr-%s.png",
                        response.getOutTradeNo());
                File file = new File(filePath);
                try {
                    COSFileUploadUtil.picCOS(file);
                } catch (Exception e) {
                    e.printStackTrace();
                }
        ...
        return "qr-" + outTradeNo + ".png"; //可能不行，先看云服务能不能上传成功
    }
}
